...
void win(){
  if(win == 1){
    ...
    text("You have beat the lock! There is no satisfying end because just because", width/6, height/2);
    text("Can you try it again by clicking on the box", width/4, height/2-40);
    fill(255);
